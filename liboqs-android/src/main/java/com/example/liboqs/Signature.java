...
public class Signature {
    ...
    * \brief Return secret key
    ...
    public List<String> get_details() {
        ...
        details.add(alg_details_.method_name);
        details.add(alg_details_.alg_version);
        details.add(String.valueOf(alg_details_.claimed_nist_level));
        details.add(String.valueOf(alg_details_.is_euf_cma));
        details.add(String.valueOf(alg_details_.length_public_key));
        details.add(String.valueOf(alg_details_.length_secret_key));
        details.add(String.valueOf(alg_details_.max_length_signature));
        return details;
    }
